        ...
        <div>
            ...
            <asp:Table runat="server">
                <asp:TableRow>
                    ...
                    <asp:TableCell><asp:TextBox ID="tb_userid" runat="server" Height="25px" Width="137px"/></asp:TableCell>
                </asp:TableRow>

                <asp:TableRow>
                    <asp:TableCell>Password :</asp:TableCell>
                    <asp:TableCell><asp:TextBox ID="tb_pwd" runat="server" Height="24px" Width="137px" TextMode="Password"/></asp:TableCell>
                </asp:TableRow>
            ...
            <p>New user?<asp:HyperLink runat="server" NavigateUrl="~/Register.aspx"> Sign up here</asp:HyperLink></p>
        </div>
    </form>
</body>
</html>
